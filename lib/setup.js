...
module.exports.getSetupForData = async ({ chalk, data, inquirer, model, setupData }) => {
  ...
  const answers = await inquirer.prompt([
    ...
    },
    {
      ...
      choices: ({ format }) => [
        {
          name: `src/_data/${model.modelName}.${format}`,
          value: {
            fileName: `src/_data/${model.modelName}.${format}`
          }
        },
        {
    ...
    },
    {
      ...
      default: ({ format }) => `src/_data/${model.modelName}.${format}`,
...
module.exports.getSetupForPage = async ({ chalk, data, inquirer, model, setupData }) => {
  ...
  if (pageType === "single") {
    const { locationSource, locationValue } = await inquirer.prompt([
      ...
      {
        when: ({ locationSource }) => locationSource === "src",
        type: "input",
        name: "locationValue",
    ...
    answers.location = locationSource === "src" ? { fileName: locationValue } : { fileNameField: locationValue }
  } else {
